      ...
      <div class="container">
         <div class="row no-gutters">
            ...
            <div class="col-lg-3 col-md-6">
               <div class="round" data-value="1" data-number="{{convertUtf8($statistic->quantity)}}" data-size="200" data-thickness="6" data-fill="{
                     &quot;color&quot;: &quot;#{{$bs->base_color}}&quot;
                     }">
                  <strong></strong>
      ...
      <div class="blog-carousel owl-carousel owl-theme common-carousel">
         ...
         <div class="single-blog">
            ...
            <div class="blog-txt">
               ...
               <h4 class="blog-title"><a href="{{route('front.blogdetails', [$blog->slug, $blog->id])}}">{{strlen($blog->title) > 40 ? mb_substr($blog->title, 0, 40, 'utf-8') . '...' : $blog->title}}</a></h4>
...
<div class="partner-section">
   <div class="container {{$be->theme_version != 'light' ? 'top-border' : ''}}">
      <div class="row">
         <div class="col-md-12">
